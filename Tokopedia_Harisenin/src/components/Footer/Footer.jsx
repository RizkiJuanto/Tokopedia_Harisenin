      ...
      <div className="flex flex-col flex-wrap justify-center items-center max-h-96 mt-5 mr-36 mb-7 ml-36 max-w-screen-2xl">
        ...
        <div className="block p-0 mb-5 min-w-52 text-primary">
          ...
          <ul className="flex flex-wrap ">
            <li>
              <img className="h-5 w-13 pr-3" src={PciLogo} alt="" />
            </li>
            <li>
              <img className="h-5 w-13 pr-3" src={IsoLogo} alt="" />
            </li>
            <li>
              <img className="h-5 w-13 pr-3" src={IsoLogo} alt="" />
            </li>
          ...
          <div className="flex flex-wrap justify-around w-full h-14 item-center content-center">
            <div className="footerContentOSand">
              <img
                className="h-10 w-24"
                src={gambar22}
                alt="Download Tokopedia dari Google Play Store"
              />
            </div>
            <div className="footerContentOSios">
              <img
                className="h-10 w-24"
                src={gambar23}
                alt="Download Tokopedia dari Apps Store"
              />
            </div>
            <div className="footerContentOshua">
              <img
                className="h-10 w-24"
                src={huaweiAppLogo}
                alt="Download Tokopedia dari Huawei Gallery"
              />
            </div>
          </div>
          <div className="p-2 items-center content-center">
            <p className="flex items-center justify-center mb-2 text-primary">
              <FaRegCopyright className="pr-1 text-primary" />{" "}
              2009-2024,HariSenin Group 3B
            </p>
          </div>
          <div className="flex justify-around items-center content-center w-full h-14">
            <button
              className="h-full w-full text-2xl font-bold bg-white text-primary"
              type="button"
            >
              Indonesia
            </button>
            <button
              className="h-full w-full text-2xl font-bold bgPrimaryColor text-[white]"
              type="button"
            >
              English
            </button>
