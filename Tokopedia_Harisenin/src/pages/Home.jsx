...
const Home = () => {
  return (
    <div className="mainHomePage relative block w-full h-full top-[5%] mt-0 mr-auto mb-3 ml-0">
                ...
                <div className="topUpPilihan flex relative">
                  <div className="pilihanKiri flex relative justify-around items-center w-full border-b-2 border-solid border-b-[#030b1f] border-r-[#6d7588]">
                    <div className="pilihan ">
                      <button className='border-none text-2xl font-semibold flex items-center text-center h-10 bg-white py-0 px-6' type='button'>Pulsa</button>
                    </div>
                    <div className="pilihan">
                      <button className='border-none text-2xl font-semibold flex items-center text-center h-10 bg-white py-0 px-6' type='button'>Pulsa</button>
                    </div>
                  ...
                  <div className="pilihanKanan w-14 flex justify-center items-center border-b-2 border-solid border-[#6d7588]">
                    <button className='pilihan border-none text-2xl font-semibold flex items-center text-center h-10 bg-white py-0 px-6' type=''>icon</button>
                  </div>
                </div>
                <div className="topUpNominal flex relative min-h-24">
                  <div className="topUpContainer relative flex justify-around grow-1 shrink basis-auto flex-row w-full p-1.5 min-w-0">
                    <div className="label flex flex-col justify-center p-1.5">
                      <label htmlFor="nomor" className="nomorTelepon text-xs font-bold leading-5 inline-block pointer-events-none text-[#6d7588] mb-1 truncate whitespace-nowrap ">Nomor Telepon</label>
                      <div className="labelContainer m-0 relative">
                        <div className="labelInput h-10 rounded bg-white border border-solid border-[#e5e7e9] p-1">
                          <input className='items-center h-full border-none pl-1' type="number" placeholder='Nomor Telepon'/>
                        </div>
                      </div>
                    </div>
                    <div className="label flex flex-col justify-center p-1.5">
                      <label htmlFor="nominal" className="nominalTopUp text-xs font-bold leading-5 inline-block pointer-events-none text-[#6d7588] mb-1 truncate whitespace-nowrap ">Nominal</label>
                      <div className="labelContainer m-0 relative">
                        <div className="labelInput h-10 rounded bg-white border border-solid border-[#e5e7e9] p-1">
                          <input className='items-center h-full border-none pl-1' type="number" placeholder='Nominal'/>
                        </div>
                      </div>
                    </div>
                    <div className="label flex flex-col justify-center p-1.5">
