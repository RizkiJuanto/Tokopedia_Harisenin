    ...
    <div className="h-[100vh] flex flex-col justify-center items-center bg-white">
      <div className='bg-white rounded-md p-8 shadow-lg'>
        <div className='flex flex-col items-center justify-center mb-8 mt-6'>
          ...
          <p className='p-1'>Sudah punya akun Tokopedia? <span className='primaryColor'>Masuk</span> </p>
        </div>
        <form action="">
          <div className='flex flex-col'> 
            <input className='w-96 p-3 border-2 border-gray-300 rounded-md' type="email" placeholder="Nomor HP atau Email" />
            <label className="text-gray-500 mt-2 text-sm" htmlFor="">Contoh: email@tokopedia.com</label>
          </div>
        ...
        <div className='flex flex-col items-center justify-center mt-4 text-sm'>
          ...
          <p><span className='primaryColor font-semibold'>Syarat & Ketentuan</span> serta <span className='primaryColor font-semibold'>Kebijakan Privasi Tokopedia.</span> </p>
        </div>
      </div>
